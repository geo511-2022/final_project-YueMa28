...
The deep learning model used in this study is proposed in *Time series classification from scratch with deep neural networks: A strong baseline* in 2017. In this paper, I keep the original structure of the model from the paper and train the model with our dataset.
