...
```{r}
print(paste("There are nan values in mean daily airtemperature data: ",as.character(NaN %in% tas_arr,seq='')))
print(paste("There are infinitive values in mean daily air temperature data: ",as.character(Inf %in% tas_arr,seq='')))

print(paste("The min value of mean daily air temperature data (without nan): ",min(tas_arr,na.rm = TRUE)))
print(paste("The max value of mean daily air temperature data (without nan): ",max(tas_arr,na.rm = TRUE)))
...
print(paste("The min value of normalized mean daily air temperature data (without nan): ",min(norm_tas,na.rm = TRUE)))
print(paste("The max value of normalized mean daily air temperature data (without nan): ",max(norm_tas,na.rm = TRUE)))
```
