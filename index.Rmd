...
pr_rasters_res <- terra::rast(nrows=1634, ncols=2035, nlyrs=12,xmin=16.54986, xmax=27.51653, ymin=-34.83347, ymax=-28.03347)

pr_rasters<- resample(pr_rasters, pr_rasters_res, method="bilinear")
...
for(i in 1:11){
  ...
  current_rasters_res <- terra::rast(nrows=1634, ncols=2035, nlyrs=12,xmin=16.54986, xmax=27.51653, ymin=-34.83347, ymax=-28.03347)
  current_raster_norm<- resample(current_raster_norm, current_rasters_res, method="bilinear")
...
rsds_rasters_res <- terra::rast(nrows=1634, ncols=2035, nlyrs=12,xmin=16.54986, xmax=27.51653, ymin=-34.83347, ymax=-28.03347)

rsds_rasters<- resample(rsds_rasters, rsds_rasters_res, method="bilinear")
...
tas_rasters_res <- terra::rast(nrows=1634, ncols=2035, nlyrs=12,xmin=16.54986, xmax=27.51653, ymin=-34.83347, ymax=-28.03347)

tas_rasters<- resample(tas_rasters, tas_rasters_res, method="bilinear")
ggplot() +
