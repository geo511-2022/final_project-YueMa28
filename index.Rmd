...
library(downloader)
temp_directory <- '/Users/mayue/Downloads/'
ndvi_directory <- '/Users/mayue/Downloads/final_project-YueMa28/raw_ndvi_modis'
env_directory <- '/Users/mayue/Downloads/final_project-YueMa28/env_data'
UBbox_directory <- "/Users/mayue/Box Sync/YueMa/Time series classification"
...
names(temp_rasters) <- c(1:12)
#temp_rasters_df <- as.data.frame(temp_rasters, xy = TRUE) 
str(temp_rasters_df)


ggplot() +
  geom_spatraster(data=temp_rasters,maxcell = 100) +
